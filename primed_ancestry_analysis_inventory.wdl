...
workflow primed_ancestry_analysis_inventory {
    input {
    ...
    call write_primed_ancestry_analysis_inventory_table {
...
task write_primed_ancestry_analysis_inventory_table {
    input {
        Map[String, String] workspaces
        String output_workspace_name
        String output_workspace_namespace
    ...
    command <<<
        set -e
        Rscript /usr/local/primed-inventory-workflows/write_primed_ancestry_analysis_inventory_table.R \
